...
<head>
	...
	<title>Barangay Position -  Integrated Barangay Information System</title>
</head>
<body>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_position.php" >
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">Example: Captain is for 1, Kagawad 1 is for 2 and so on.</small>
                                </div>
