...
<?php 
    ...
    $query1 = "SELECT * FROM tblofficials JOIN tblposition ON tblofficials.position=tblposition.id WHERE tblposition.position NOT IN ('SK Chairrman','Secretary','Treasurer', 'Lupon Tagapamahala')
...
<head>
	...
	<title>Certificate of Indigency -  Integrated Barangay Information System</title>
    <style>
        @page  
        { 
								...
								<div class="card-body m-5" id="printThis">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-12">
                                            ...
                                            this City of Talisay, Negros Occidental.</h2>
                                        </div>
                                        <div class="col-md-12">
