...
<head>
	...
	<title>Dashboard -  Integrated Barangay Information System</title>
</head>
<body>
							...
							<div class="card card-stats card-round" style="background-color:#880a14; color:#fff">
								<div class="card-body">
									<div class="row">
										...
										<div class="col-6 col-stats">
											<div class="numbers mt-4">
												<h2 class="fw-bold text-uppercase">Purok Names</h2>
									...
									<div class="row">
										...
										<div class="col-6 col-stats">
											<div class="numbers mt-4">
												...
												<?php $total_amount = isset($revenue['am']) ? $revenue['am'] : 0; ?>
												<h3 class="fw-bold text-uppercase">P<?= number_format($total_amount, 2) ?></h3>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title fw-bold">LGU Mission and Vision Statement</div>
									</div>
								</div>
								<div class="card-body">
