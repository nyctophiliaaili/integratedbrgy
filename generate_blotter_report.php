...
<?php 
    ...
    $query1 = "SELECT * FROM tblofficials JOIN tblposition ON tblofficials.position=tblposition.id WHERE tblposition.position NOT IN ('SK Chairman','Secretary','Treasurer', 'Lupon Tagapamahala')
...
<head>
	...
	<title>Blotter Report -  Integrated Barangay Information Systemm</title>
</head>
<body>
